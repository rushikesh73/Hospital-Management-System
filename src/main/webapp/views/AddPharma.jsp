...
<body>
    ...
    <div class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="Bill">Bill</a>
            <a href="ExitPnt">Exit Patient</a> </div>
    </div>
    
    <div class="content">
        <div class="form-container">
            <h2>Add Patient Pharm</h2>
            <form action="/save" method="post">
                ...
                <button type="button" onclick="addnewmedicine()">Add New Medicine</button><br><br>
                <div class="form-group">
    ...
    <script>
        function addnewmedicine() {
            ...
            newMedicine.classList.add("form-group");
            newMedicine.innerHTML = `<label for="medicine">Medicine:</label>
                                    <input type="text" name="medicine" required>
                                    <label for="price">Price:</label>
                                    <input type="text" name="price" required>`;
